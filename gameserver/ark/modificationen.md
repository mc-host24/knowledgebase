...
In naher Zukunft werden wir eine Modifikationsverwaltung in unserem Webinterface einbauen, mit der du Mods direkt auf deinem Server installieren und aktivieren kannst.
Wir bitten dich daher, bis dahin noch etwas Geduld zu haben und die Modifikationen manuell zu installieren.

## Wie installiere ich Modifikationen auf meinem ARK: Survival Evolved-Server?
...
Du kannst den Pfad einfacher herausfinden, indem du den Steam-Client öffnest und dort auf die Schaltfläche `Bibliothek` klickst.
Anschließend kannst du nach ARK: Survival Evolved suchen und mit der rechten Maustaste auf das Spiel klicken.
Klicke nun auf `Eigenschaften` und anschließend auf `Lokale Dateien`. Danach klickst du auf `Durchsuchen`, und du findest den Pfad zu deiner ARK: Survival Evolved-Installation.
{% endhint %}
...
Wie du dich mit deinem Server per SFTP verbindest, findest du auch in unserem YouTube-Video [https://www.youtube.com/watch?v=KA9z-rLotnk](https://www.youtube.com/watch?v=KA9z-rLotnk) oder unter [Mit (S)FTP auf Rootserver verbinden](rootserver/sftp-verbinden.md).
{% endhint %}
